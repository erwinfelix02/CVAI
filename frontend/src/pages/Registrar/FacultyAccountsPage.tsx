...
export default function FacultyAccountsPage() {
  ...
  }, [facultyList, query, statusFilter]);
  ...
  const handleEditClick = async (faculty: Faculty) => {
    ...
    try {
      ...
      setEditFaculty({
        id: full._id,
        name: [full.firstName, full.middleName, full.lastName]
          .filter(Boolean)
          .join(" "),
        email: full.email,
  ...
  return (
    <>
      ...
      <div className="registrar-faculty-page">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-start gap-3 mb-3 mb-md-4">
          <div>
