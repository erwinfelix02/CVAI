...
export function WhyCampusAI() {
  ...
  return (
    <section className="why-gradient reveal">
        ...
        <div className="row align-items-center justify-content-center g-5">
          ...
          <div className="col-md-4 reveal delay-1">
            ...
            <ul className="list-unstyled text-muted why-list">
              <li className="mb-2 d-flex align-items-start gap-2 reveal delay-2">
                <img src={CheckIcon} alt="" width={18} height={18} />
                <span>Instant answers without searching multiple websites</span>
              </li>
              <li className="mb-2 d-flex align-items-start gap-2 reveal delay-3">
                <img src={CheckIcon} alt="" width={18} height={18} />
                <span>Personalized recommendations based on your profile</span>
              </li>
              <li className="mb-2 d-flex align-items-start gap-2 reveal delay-4">
                <img src={CheckIcon} alt="" width={18} height={18} />
                <span>Easy access to campus resources and support</span>
              </li>
              <li className="mb-2 d-flex align-items-start gap-2 reveal delay-5">
                <img src={CheckIcon} alt="" width={18} height={18} />
                <span>Never miss deadlines</span>
              </li>
            </ul>

            <div className="text-center text-md-start mt-4 reveal delay-6">
              <Button
