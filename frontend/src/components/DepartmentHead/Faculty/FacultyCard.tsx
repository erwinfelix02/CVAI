...
export type FacultyStatus = "Available" | "Full Load" | "Overloaded";
...
export default function FacultyCard({ faculty, onView }: FacultyCardProps) {
  ...
  return (
    <div className="faculty-card">
        ...
        <div className="faculty-details">
          ...
          <div className="faculty-subjects">
            {faculty.subjects.map((subject) => (
              <span className="faculty-subject" key={subject}>
                {subject}
              </span>
            ))}
          </div>
      ...
      {/* =====================================================
          2. LOAD BAR + VIEW BUTTON (RIGHT SIDE - SAME LEVEL)
          ===================================================== */}
      <div className="faculty-right-section">
        <div className="faculty-load">
          <div className="faculty-load-header">
            <span>Load</span>
            <span className="faculty-units-text">
        ...
        <div className="faculty-action-column">
          <button
            type="button"
