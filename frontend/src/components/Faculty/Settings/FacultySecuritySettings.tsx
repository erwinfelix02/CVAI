...
export default function FacultySecuritySettings() {
  ...
  const isDirty = formData.newPassword !== "" || formData.confirmPassword !== "";
        ...
        >
          ...
          >
            <div className="modal-content border-0 shadow-lg rounded-4 text-center p-4">
              ...
              <h5 className="fw-bold text-dark mb-1">Discard Password Changes?</h5>
              <p className="text-secondary small mb-4">
                You have entered password text. Leaving now will clear your inputs.
              </p>
        ...
        >
          ...
          >
            <div className="modal-content border-0 shadow-lg rounded-4 text-center p-4">
              ...
              <h5 className="fw-bold text-dark mb-1">Confirm Password Change?</h5>
              <p className="text-secondary small mb-4">
